...
public class HouseServiceImpl implements HouseService {
    ...
    @Override
    public PageInfo<House> findAll(PageInfo<House> info, House house) {
        info.setCount(houseMapper.getCount());
        info.setData(houseMapper.findAll(house.getHouseNo(),(info.getPage() - 1) * info.getLimit(), info.getLimit()));
        return info;
    }
